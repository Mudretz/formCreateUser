...
import { getAdvantagesData } from "../../../../../app/store/data/selector.ts";
import { advantagesReceived } from "../../../../../app/store/data/data.ts";
import { stepDecrease, stepIncrease } from "../../../../../app/store/step/step.ts";
